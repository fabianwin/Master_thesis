...
col =["date","number of tweets","daily average Stanford_sentiment score","daily average TextBlob_sentiment score","daily average Flair_sentiment score","sentiment volatility","sentiment momentum","reversal","previous day's return", "volume", "price momentum", "price volatility"]
