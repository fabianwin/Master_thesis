...
class CustomEnv:
    ...
    def __init__(self, df, df_normalized, initial_balance=1000, lookback_window_size=60, Render_range=150, Show_reward=False, Show_indicators=False, normalize_value=40000):
...
if __name__ == "__main__":
    ...
    Random_games(train_env, visualize=False, test_episodes = 1000, comment="random games")
