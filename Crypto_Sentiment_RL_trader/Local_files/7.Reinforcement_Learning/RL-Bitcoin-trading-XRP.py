...
class CustomAgent:
    ...
    def __init__(self, lookback_window_size=50, lr=0.00005, epochs=1, optimizer=Adam, batch_size=32, model="", depth=0, comment=""):
        ...
        # folder to save models
        path = "/Users/fabianwinkelmann/Library/Mobile Documents/com~apple~CloudDocs/Master Thesis/Code/Crypto_Sentiment_RL_trader/7.Reinforcement_Learning/XRP/"
...
if __name__ == "__main__":
    ...
    #test
    #test_multiprocessing(CustomEnv, CustomAgent, test_df, test_df_nomalized, num_worker = 32, visualize=False, test_episodes=1000, folder="/Users/fabianwinkelmann/Library/Mobile Documents/com~apple~CloudDocs/Master Thesis/Code/Crypto_Sentiment_RL_trader/7.Reinforcement_Learning/Best_actors/XRP/All_features", name="2252.51_Crypto_trader", comment="All features")
    #test_multiprocessing(CustomEnv, CustomAgent, test_df, test_df_nomalized, num_worker = 32, visualize=False, test_episodes=1000, folder="/Users/fabianwinkelmann/Library/Mobile Documents/com~apple~CloudDocs/Master Thesis/Code/Crypto_Sentiment_RL_trader/7.Reinforcement_Learning/Best_actors/XRP/Finance_features", name="4905.58_Crypto_trader", comment="Finance features")
    #test_multiprocessing(CustomEnv, CustomAgent, test_df, test_df_nomalized, num_worker = 32, visualize=False, test_episodes=1000, folder="/Users/fabianwinkelmann/Library/Mobile Documents/com~apple~CloudDocs/Master Thesis/Code/Crypto_Sentiment_RL_trader/7.Reinforcement_Learning/Best_actors/XRP/Network_features", name="2801.28_Crypto_trader", comment="Network features")
    #test_multiprocessing(CustomEnv, CustomAgent, test_df, test_df_nomalized, num_worker = 32, visualize=False, test_episodes=1000, folder="/Users/fabianwinkelmann/Library/Mobile Documents/com~apple~CloudDocs/Master Thesis/Code/Crypto_Sentiment_RL_trader/7.Reinforcement_Learning/Best_actors/XRP/Sentiment_features", name="2153.03_Crypto_trader", comment="Sentiment features")
