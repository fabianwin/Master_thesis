...
from PPO_model import Actor_Model, Critic_Model
from utils import TradingGraph, Write_to_file
...
def Random_games(env, visualize, train_episodes = 50, training_batch_size=360):
    average_net_worth = 0
...
def train_agent(env, visualize=False, train_episodes = 50, training_batch_size=360):
    ...
    for episode in range(train_episodes):
        ...
        print("Episode: {} | Net Worth {:.2f} | Average networth {:.2f} | #Orders {}".format(episode, env.net_worth, average, env.episode_orders))
...
def test_agent(env, visualize=True, test_episodes=10):
    ...
    for episode in range(test_episodes):
        ...
        while True:
            ...
            if env.current_step == env.end_step:
                average_net_worth += env.net_worth
                print("Episode: {} | Net Worth {:.2f}".format(episode, env.net_worth, env.episode_orders))
                break
...
train_agent(train_env, visualize=False, train_episodes=200, training_batch_size=500)
print("-")
test_agent(test_env, visualize=False, test_episodes=100)
#Random_games(train_env, visualize=False, train_episodes = 3, training_batch_size=360)
