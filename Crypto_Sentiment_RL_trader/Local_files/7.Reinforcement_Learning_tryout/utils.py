...
class TradingGraph:
    ...
    def render(self, df, net_worth, trades):
        ...
        self.fig.suptitle('Reinforcement learning on BTC with product features', fontsize=16)
        ...
        my_file = 'Bitcoin_product_features.png'
        ...
        filename = 'Bitcoin_trading_network.png'
