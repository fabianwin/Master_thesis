...
def construct_sentiment_feature_set(twitter_df, symbol, set_description):
    """
    - Parameters: twitter_df which has all the scraped tweets and symbol and set_description is used to define which Coin and ticker/news set is underlying
    - Returns: df_final, a df which has relevant features (scaled) descriping the sentiment of ticker/news set
    """
