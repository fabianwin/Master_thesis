...
class LPPLS(object):
    ...
    def plot_fit(self,symbol,show_tc=False):
        """
        Args:
        ...
        my_file = 'LPPLS_fit_1_'+symbol+".png"
    ...
    def plot_confidence_indicators(self, res, symbol):
        """
        Args:
        ...
        my_path = os.path.abspath(r'/Users/fabianwinkelmann/Library/Mobile Documents/com~apple~CloudDocs/Master Thesis/Code/Crypto_Sentiment_RL_trader/4.Feature_Engineering/LPPLS')
        my_file = 'confidence_indicators_1_'+symbol+".png"
        fig.savefig(os.path.join(my_path, my_file))
