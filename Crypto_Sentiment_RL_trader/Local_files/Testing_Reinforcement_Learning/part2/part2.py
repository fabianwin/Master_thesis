...
class CustomEnv:
    ...
    def reset(self, env_steps_size = 0):
        ...
        if env_steps_size > 0: # used for training dataset
            print(self.lookback_window_size)
            print(self.df_total_steps)
            print(env_steps_size)
            print(self.df_total_steps - env_steps_size)
            print("random",random.randint(50,469))
...
Random_games(test_env, visualize=False, train_episodes = 1, training_batch_size=300)
Random_games(train_env, visualize=False, train_episodes = 1, training_batch_size=300)
