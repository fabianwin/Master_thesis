...
def Random_games(env, visualize, test_episodes = 50, comment="" , training_batch_size=300):
    average_net_worth = 0
    average_orders = 0
...
if __name__ == "__main__":
    df = pd.read_csv('/Users/fabianwinkelmann/github/Master_thesis/Crypto_Sentiment_RL_trader/Local_files/7.Reinforcement_Learning/part7/BTCUSD_1h.csv')
    df = df.dropna()
    ...
    train_multiprocessing(CustomEnv, agent, train_df, train_df_nomalized, num_worker = 32, training_batch_size=500, visualize=False, EPISODES=200)
    ...
    test_multiprocessing(CustomEnv, CustomAgent, test_df, test_df_nomalized, num_worker = 16, visualize=True, test_episodes=1000, folder="/Users/fabianwinkelmann/github/Master_thesis/Crypto_Sentiment_RL_trader/Local_files/7.Reinforcement_Learning/part7/2021_02_21_17_54_Crypto_trader", name="3447.20_Crypto_trader", comment="3 months")

    #done by myself
    #Random_games(CustomEnv, visualize=True, test_episodes = 50, training_batch_size=300)
