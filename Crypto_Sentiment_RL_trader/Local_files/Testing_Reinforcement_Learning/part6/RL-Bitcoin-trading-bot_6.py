...
if __name__ == "__main__":
    df = pd.read_csv('/Users/fabianwinkelmann/github/Master_thesis/Crypto_Sentiment_RL_trader/Local_files/7.Reinforcement_Learning/part6/BTCUSD_1h.csv')
    ...
    test_multiprocessing(CustomEnv, agent, test_df, num_worker = 16, visualize=False, test_episodes=1000, folder="/Users/fabianwinkelmann/github/Master_thesis/Crypto_Sentiment_RL_trader/Local_files/7.Reinforcement_Learning/part6/2021_01_21_20_06_Crypto_trader", name="1984.93_Crypto_trader", comment="Dense")
